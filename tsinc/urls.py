...
urlpatterns = [
    ...
    path('createremission/', views.create_remission, name='remission'),
    ...
    path('subtractproduc/<int:id>/<str:path>', views.subtract_product, name='subtract_product'),
    path('cleanproductbox/<str:path>', views.clean_productbox, name='clean_productbox'),
    path('remissions/', views.remissions, name='remissions'),
    path('deleteremission/<int:id>', views.delete_remission, name='delete_remission'),
    path('productremission/<int:id>', views.product_remission, name='product_remission'),
