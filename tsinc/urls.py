...
urlpatterns = [
    ...
    path('delete_file_item/<int:id>', views.delete_file_item, name='delete_file_item'),
    ...
    path('delete_invoice_file/<int:id>', views.delete_invoice_file, name='delete_invoice_file'),
    ...
    path('delete_folder_item/<int:id>', views.delete_folder_item, name='delete_folder_item'),
    ...
    path('save_offer_item/<int:id>', views.save_offer_item, name='save_offer_item'),
