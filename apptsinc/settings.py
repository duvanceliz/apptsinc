"""
Django settings for apptsinc project.
...
MIDDLEWARE = [
    ...
    'tsinc.middleware.AuditLogMiddleware',
]

ROOT_URLCONF = 'apptsinc.urls'
...
TEMPLATES = [

    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'environment': 'tsinc.jinja2_env.environment',
        },
    },
...
WSGI_APPLICATION = 'apptsinc.wsgi.application'
